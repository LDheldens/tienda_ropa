...
# def boxlistView(request):
#     data = {
#         'title': 'Listado de Caja',
#         'box': Box.objects.all()
#     }
#     return render(request, 'frm/box/list.html', data)
#
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            if action == 'add':
                ...
                box.cash_sale = request.POST['cash_sale']
                # box.cash_credit = request.POST['cash_credit']
                box.sale_card = request.POST['sale_card']
                box.initial_box = request.POST['initial_box']
                box.box_final = request.POST['box_final']
