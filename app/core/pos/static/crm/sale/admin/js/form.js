...
var vents = {
    ...
    calculate_invoice: function () {
        ...
        $.each(this.details.products, function (i, item) {
            ...
            // item.cash = item.cant * parseFloat(item.price_current);
...
$(function () {
        ...
        .on('change', function () {
            ...
            switch (id) {
                case "contado":
                    ...
                    fvSale.disableValidator('initial');
    ...
    select_paymentmethod.on('change', function () {
        var id = $(this).val();
        hideRowsVents([{'pos': 0, 'enable': false}, {'pos': 1, 'enable': false}, {'pos': 2, 'enable': true}]);
        ...
        switch (id) {
            ...
            case "tarjeta_debito_credito":
                ...
                input_titular.val('');
                hideRowsVents([{'pos': 1, 'enable': false}]);
                break;
